...
// };
// NEW 
// export const isRGBTuple = (input: unknown): input is TRGB => 
//   Array.isArray(input) && 
//   input.length === 3 && 
//   isNumber(input[0]) && input[0] >= 0 && input[0] <= 255 &&
//   isNumber(input[1]) && input[1] >= 0 && input[1] <= 255 &&
//   isNumber(input[2]) && input[2] >= 0 && input[2] <= 255;